...
sectionIndex: 2
name: Clean Up
metaDescription: Clean up your Kubernetes environment by removing CI/CD pipeline resources, ArgoCD, and deployed applications after the pipeline tutorial.
---
...
These commands will delete entire namespaces including the CI/CD pipeline and deployed applications. Only use on your local development cluster.
