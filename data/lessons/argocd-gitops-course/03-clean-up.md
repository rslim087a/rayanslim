...
sectionIndex: 2
name: Clean Up
metaDescription: Clean up your Kubernetes environment by removing ArgoCD GitOps resources and applications after the GitOps deployment tutorial.
---
...
These commands will delete entire namespaces including ArgoCD and deployed applications. Only use on your local development cluster.
