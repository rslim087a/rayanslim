...
sectionIndex: 2
name: Clean Up
metaDescription: Clean up your Kubernetes environment by removing Vault, External Secrets Operator, and related resources after the secret management tutorial.
---
...
These commands will delete entire namespaces including Vault and the External Secrets Operator. Only use on your local development cluster.
