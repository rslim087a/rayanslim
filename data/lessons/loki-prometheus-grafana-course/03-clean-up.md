...
sectionIndex: 2
name: Clean Up
metaDescription: Clean up your Kubernetes environment by removing Loki, Prometheus, and Grafana resources after the unified monitoring tutorial.
---
...
These commands will delete entire namespaces including the unified monitoring stack. Only use on your local development cluster.
